...
@endsection
@section('page')
    <script src="{{asset("assets/sites/admission/js/admin/setting.js")}}"></script>
@endsection
@section('breadcrumb')
...
@section('content')
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-white pb-0 pt-sm-0 pr-sm-0 header-elements-sm-inline">
                    ...
                    <div class="header-elements">
                        <ul class="nav nav-tabs nav-tabs-bottom card-header-tabs mx-0">
                            ...
                            <li class="nav-item">
                                <a href="#card-bottom-notify" class="nav-link {{isset($msg['app']) ? 'active' : null}}" data-toggle="tab"><i class="icon-file-empty mr-2"></i>PPDB Online</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="card-body tab-content">
                    <div class="tab-pane fade {{empty($msg) || isset($msg['school']) || isset($msg['logo'])? 'show active' : null}}" id="card-bottom-school">
                        ...
                        @endif
                        <form action="{{route('admission.admin.setting')}}" method="post">
                            {{csrf_field()}}
                    ...
                    <div class="tab-pane fade {{isset($msg['app']) ? 'show active' : null}}" id="card-bottom-notify">
                        @isset($msg['notify'])
                            <div class="alert alert-success">
                                {{$msg['notify']}}
                            </div>
                        ...
                        <form action="{{route('admission.admin.setting')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="setting_app_name" class="form-control" value="{{$setting->setting_app_name}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">Sub Nama Aplikasi :</label>
                                <div class="col-md-8">
                                    <input type="text" name="setting_app_subname" class="form-control" value="{{$setting->setting_app_subname}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" name="setting_app_notify" class="form-control daterange-time" value="{{\Carbon\Carbon::parse($setting->setting_app_notify)->format('d/m/Y H:i')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <button type="submit" class="btn bg-info btn-labeled btn-labeled-left" name="update" value="app"><b><i class="icon-floppy-disk"></i></b> SIMPAN</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade {{isset($msg['user']) ? 'show active' : null}}" id="card-bottom-user">
                        ...
                        <form action="{{route('admission.admin.setting')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="user_name" class="form-control" value="{{auth('admission')->user()->user_name}}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="user_fullname" class="form-control" value="{{auth('admission')->user()->user_fullname}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="database_id" class="form-control select">
                                        <option value="1">Data Pendaftaran</option>
                                    </select>
        ...
        <div class="col-md-4">
            <div class="card">
                <form action="{{route('admission.admin.setting')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="card-body">
                        <a href="#">
                            <img class="card-img-top img-fluid" src="{{asset('storage/sites/admission/images/logo_school.png')}}" alt="">
                        </a>
                        <hr>
                        @isset($msg['logo'])
                            <div class="alert alert-success">
